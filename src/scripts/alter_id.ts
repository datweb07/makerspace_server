...
async function main() {
  ...
  const queries = [
    "ALTER TABLE people.staff ALTER COLUMN id TYPE VARCHAR(255);",
    "ALTER TABLE people.staff ALTER COLUMN id DROP DEFAULT;",
    "ALTER TABLE people.interns ALTER COLUMN id TYPE VARCHAR(255);",
    "ALTER TABLE people.interns ALTER COLUMN id DROP DEFAULT;",
    "ALTER TABLE people.club_members ALTER COLUMN id TYPE VARCHAR(255);",
    "ALTER TABLE people.club_members ALTER COLUMN id DROP DEFAULT;",
  ];
