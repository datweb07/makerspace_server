...
const env = {
  ...
  POSTGRES_DB_HOST_EN: process.env.POSTGRES_DB_HOST_EN ?? process.env.POSTGRES_DB_HOST ?? "58.186.6.76",
  POSTGRES_DB_HOST_VI: process.env.POSTGRES_DB_HOST_VI ?? process.env.POSTGRES_DB_HOST ?? "58.186.6.76",
  POSTGRES_USER_EN: process.env.POSTGRES_USER_EN ?? process.env.POSTGRES_USER ?? "iscm",
  POSTGRES_USER_VI: process.env.POSTGRES_USER_VI ?? process.env.POSTGRES_USER ?? "iscm",
  POSTGRES_USER: process.env.POSTGRES_USER ?? "iscm",
  POSTGRES_PASSWORD_EN: process.env.POSTGRES_PASSWORD_EN ?? process.env.POSTGRES_PASSWORD ?? "#$Ueh@ISCM",
  POSTGRES_PASSWORD_VI: process.env.POSTGRES_PASSWORD_VI ?? process.env.POSTGRES_PASSWORD ?? "#$Ueh@ISCM",
